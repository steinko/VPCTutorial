...
class DescribeVpcEndpointsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.DescribeVpcEndpointsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_4_1.DescribeVpcEndpointsResult.filterSensitiveLog,
        };
