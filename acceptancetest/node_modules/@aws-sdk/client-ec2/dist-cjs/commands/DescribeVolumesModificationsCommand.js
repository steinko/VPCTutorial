...
class DescribeVolumesModificationsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.DescribeVolumesModificationsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_4_1.DescribeVolumesModificationsResult.filterSensitiveLog,
        };
