...
class CreateVpnGatewayCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.CreateVpnGatewayRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.CreateVpnGatewayResult.filterSensitiveLog,
        };
