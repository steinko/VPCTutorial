...
class DescribeSubnetsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.DescribeSubnetsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_4_1.DescribeSubnetsResult.filterSensitiveLog,
        };
