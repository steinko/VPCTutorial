...
class DescribeInstanceAttributeCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_3_1.DescribeInstanceAttributeRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_3_1.InstanceAttribute.filterSensitiveLog,
        };
